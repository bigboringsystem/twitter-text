...
- Removed everything besides the JS implementation and moved files to the root directory.
- Added flags for each of the entity types to disable each of them entirely.
